<!DOCTYPE html><html lang="en"><head>
    ...
    <link color="#5bbad5" href="fonts/safari-pinned-tab.svg" rel="mask-icon">
    ...
    <style>
        ...
        .spinner {
            ...
            width: 50%;
            height: 50%;
            background: url('fonts/loading-logo.svg') no-repeat center center;
...
<body id="body" class="full-page-content">
    ...
    </script><img src="images/spacer.gif" referrerpolicy="no-referrer-when-downgrade" width="0" height="0" style="opacity: 0.0">
<script src="js/runtime.359e33ce9bea482c.js" type="module"></script><script src="js/polyfills.23c48c36854a939b.js" type="module"></script><script src="js/main.19298c85d8438031.js" type="module"></script>
